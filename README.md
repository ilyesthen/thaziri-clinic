# Allah - Electron + Vite + React + TypeScript + Prisma

A modern, professional desktop application built with the latest web technologies and a type-safe database layer.
